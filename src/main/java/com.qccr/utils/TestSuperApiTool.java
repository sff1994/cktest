...
public class TestSuperApiTool {
    ...
    public static LinkedMultiValueMap setupParams(LinkedMultiValueMap<String, String> vars, String data, LinkedMultiValueMap<String, String> headers) {
