 ...
 */
public class TestSuperApiToolGet {
    ...
    public static Map setupParams(Map<String, String> vars, String data, Map<String, String> headers) {
        ...
        headers.put("Cookie", "u-session-id=cc70d83705174768b5b91b8a24aaa913;session-id=wx-90990060-5cf1-4f62-9f5e-474d84cecf6d");
